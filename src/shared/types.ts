...
export interface DirectorMessage {
  ...
  ledger?: RunLedger;
  /**
   * N5 auto-replan: set when this plan was generated by the Director after a
   * prior run STALLED. `of` is the prior plan message's id (the chain link, for
   * the UI); `attempt` is 1-based replan depth, bounded by `maxReplansPerRun`.
   * Renders a "revised after a stall" badge on the PlanCard.
   */
