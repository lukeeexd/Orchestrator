...
| PRE-2 | **Session-wide budget / iteration cap** — per-agent budgets were removed in v0.24.0, so there is **no backstop**; every auto-loop must carry its own cap until this lands | `[x]` PRE-2a v0.44.0 (count cap); PRE-2b deferred | N1, N5, N11, N12, N13, N32 |
